...
#ifndef SPARKFUN_STUSB4500_SOFTWAREWIRE_H
#define SPARKFUN_STUSB4500_SOFTWAREWIRE_H
...
class STUSB4500 {
  ...
  */
  uint8_t begin(SoftwareWire &softWire, uint8_t deviceAddress = 0x28);
  ...
  */
  ...
  //I-squared-C Class
  SoftwareWire *_i2cPort; //The generic connection to user's chosen I2C hardware
  //Variables
